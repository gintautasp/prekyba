...
<tr>
		...
		<td>
			<input type="range" min="-90"  max="90" name="platuma" value="0">
		</td>
		<td>
			<input type="range" min="0" max="180" name="ilguma" value="0">
		</td>
		<td>			
